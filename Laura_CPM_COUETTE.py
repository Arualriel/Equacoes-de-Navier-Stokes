...
for i in range(1,nx):
    for j in range(ny):        
        U[i,j,0]=U[i,j,0]*y[j]/b   #############u em funcao de y


#ny = numElemY-1

for k in range(21):
    #F = -uGradU(U,dx,dy) + nu*L(U,dx,dy) - (1.0/ro)*P##funcao original
    F=-(1.0/ro)*P###############################################funcao alternativa
#    for i in range(11):
#        U[1:nx,:,0]=U[1:nx,:,0]*y[i]/b   #############u em funcao de y
